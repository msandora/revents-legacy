...
const newEventActivity = (type, event, id) => {
  return {
    type: type,
...
exports.createEventActivity = functions.firestore
  ...
  .onCreate((event) => {
    ...
    const activity = newEventActivity('newEvent', newEvent, event.id);
...
exports.cancelEventActivity = functions.firestore
  ...
  .onUpdate((event, context) => {
    ...
    const activity = newEventActivity(
      'cancelledEvent',
      updatedEvent,
